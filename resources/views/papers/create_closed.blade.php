            ...
            <form action="{{ route('papers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="abstract" rows="4" required
                                ...
                                oninput="updateWordCount(this)">{{ old('abstract') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="conference_year" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                <option value="2026" {{ old('conference_year', '2026') == '2026' ? 'selected' : '' }}>2026</option>
                                <option value="2025" {{ old('conference_year') == '2025' ? 'selected' : '' }}>2025</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="topic_area" required
                                ...
                                <option value="ai_ml" {{ old('topic_area') == 'ai_ml' ? 'selected' : '' }}>Artificial Intelligence & Machine Learning</option>
                                <option value="data_science" {{ old('topic_area') == 'data_science' ? 'selected' : '' }}>Data Science & Analytics</option>
                                <option value="healthcare" {{ old('topic_area') == 'healthcare' ? 'selected' : '' }}>Healthcare Applications</option>
                                <option value="clinical" {{ old('topic_area') == 'clinical' ? 'selected' : '' }}>Clinical Decision Support</option>
                                <option value="imaging" {{ old('topic_area') == 'imaging' ? 'selected' : '' }}>Medical Imaging</option>
                                <option value="other" {{ old('topic_area') == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="submission_type" value="abstract_only" 
                                    ...
                                    {{ old('submission_type', 'full_paper') == 'abstract_only' ? 'checked' : '' }}>
                                <span class="ml-3">
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="submission_type" value="full_paper" 
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 submission-type-radio"
                                    id="submission_type_full"
                                    {{ old('submission_type', 'full_paper') == 'full_paper' ? 'checked' : '' }}>
                                <span class="ml-3">
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-4" id="file_upload_section">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Upload Paper (PDF only) <span class="text-red-500">*</span>
                        </label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-center">
                                    <label class="flex items-center">
                                        <input type="radio" name="corresponding_author" value="0" checked
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="registration_ids[]" value="{{ $registration->id }}"
                                           ...
                                           {{ old('registration_ids') && in_array($registration->id, old('registration_ids')) ? 'checked' : '' }}>
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="author_comments" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Any special instructions or comments for the reviewers">{{ old('author_comments') }}</textarea>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleFileUpload() {
        const selectedType = document.querySelector('input[name="submission_type"]:checked');
        if (!selectedType) return;
        
        const isAbstractOnly = selectedType.value === 'abstract_only';
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            // Ensure corresponding author is selected (should always be true as first author is default)
